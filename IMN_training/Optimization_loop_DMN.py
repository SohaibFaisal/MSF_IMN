...
def run_live_optimization_DMN(num_epochs, num_samples, dataset, inner_steps, optimizer, model, train_costs,val_costs,cost_live_plot,training_data_folder,stage):
    global running
